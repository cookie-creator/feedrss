<template>
  ...
  <form class="mt-8 space-y-6" action="#" @submit="login">
    <div v-if="errorMsg" class="flex items-center justify-between py-3 px-5 bg-red-100 rounded border border-red-300 text-red-500">
      {{errorMsg}}
      <span @click="errorMsg = ''"
            class="w-8 h-8 flex items-center justify-center rounded-full transition-colors cursor-pointer hover:text-red-700">
